...
const clockOptimal = function (register) {
  const scrambler = (function () {
     ...
     *		-1: invalid input
     */
    const Solution = (clockOptimal, solution) => {
      if (clockOptimal.length != 14 || solution.length != 18) {
        return -1;
      }
      return solveIn(14, clockOptimal, solution);
    }
  ...
  register('clockOptimal', scrambler, ['clock-o', 'clock-optimal']);
}

export default clockOptimal;
